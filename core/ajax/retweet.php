...
if (isset($_POST['qoute']) && !empty($_POST['qoute'])) {
    ...
    if (isset($retweet->user_id)) {
        ...
        $for_user = Tweet::getTweet($tweet_id)->user_id;
    }
    ...
    if ($flag == false && $qoq == false && Tweet::isRetweet($tweet_id)) {
        ...
        $flag_retweeted = Tweet::userRetweeetedIt($user_id, $tweet_id);
    }
...
<div class="retweet-div">
    <a href="#" class="<?=$user_retweeted_it ? 'retweeted-i' : 'retweet-i'?>" data-user="<?php echo $user_id; ?>"
        data-tweet="<?php
if (($user_retweeted_it && !$retweet_sign) || $flaga) {
        if ($flaga == false) {
            ...
            if ($retweeted_user->tweet_id != null) {
                ...
                echo Tweet::retweetRealId($retweeted_user->retweet_id, $user_id);
            }
    ...
    ?>" data-qoq="<?php echo $qoq; ?>" data-status="<?php echo $status; ?>">
        <li><i class="fas fa-retweet icon"></i>
            <span class="option-text"><?php if ($user_retweeted_it) {
        echo 'Undo';
    }
    ?>
                Retweet</span>
    ...
    <a href="#" class="qoute" data-user="<?php echo $get_id; ?>" data-tweet="<?php
$retweet = Tweet::getRetweet($tweet_id);

    echo $tweet_id;?>">
        <li><i class="fas fa-pencil-alt icon"></i>
            <span class="option-text"> Qoute Tweet</span>
        </li>
    </a>
</div>
...
if ($retweet_comment || $qoq) {
        ...
        echo Tweet::getTweetLinks($tweet->status);
    }
    ?>
                    </p>
...
if ($qoq == false) {
            ...
            <div class="retweet-popup-footer">
                <div class="retweet-popup-footer-right">
                    <button class="qoute-it" data-tweet="<?php echo $tweet_id; ?>" data-user="<?php echo $user_id; ?>"
                        data-tmp="<?php echo $retweet_comment; ?>" data-qoq="<?php echo $qoq; ?>" type="submit"><i
                            class="fas fa-pencil-alt" aria-hidden="true"></i>Qoute</button>
                </div>
            </div>
