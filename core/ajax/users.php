    ...
    <div class="wrap5">
        ...
        ?>
                <div class="grid-share grid-users">
                    <a style="position: relative; z-index:999999; color:black" href="<?php echo $u->username; ?>"
                        onclick="window.location = '<?php echo BASE_URL . $u->username; ?>' ">
                        <img src="assets/images/users/<?php echo $u->img; ?>" alt="" class="img-share" />
                    </a>
                    <div>
                        <p>
                            <a onclick="window.location = '<?php echo BASE_URL . $u->username; ?>' " style="color:black"
                    ...
                    <div>
                      ...
                      <?=$user_follow ? 'following' : 'follow'?>" data-follow="<?php echo $user->user_id; ?>"
